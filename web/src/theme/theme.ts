import { createTheme, type ColorSystemOptions, type Shadows, type ShapeOptions, type ThemeOptions, type TransitionsOptions, type TypographyVariantsOptions } from '@mui/material';
