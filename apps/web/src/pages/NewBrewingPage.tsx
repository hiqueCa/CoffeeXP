import { Alert, Box, Button, MenuItem, Rating as MuiRating, TextField, Typography } from "@mui/material";
...
export default function NewBrewingPage() {
  ...
  const update = (field: string, value: string | number | null) => setForm((prev) => ({ ...prev, [field]: value }));
  ...
  return (
    <Box component="form" onSubmit={handleSubmit}>
      ...
      <TextField
        ...
        onChange={(e) => update("coffee_id", Number(e.target.value))}
        required
      >
      ...
      <Box sx={{ display: "flex", gap: 2 }}>
        ...
        <TextField
          ...
          margin="normal"
          value={form.ml || ""}
          onChange={(e) => update("ml", Number(e.target.value))}
          required
        />
      </Box>
